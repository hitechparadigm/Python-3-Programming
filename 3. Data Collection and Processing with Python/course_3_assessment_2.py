...
''' def add_Fruit(lst):
    modified_lst = []
    for word in lst:
        modified_lst.append('Fruit: ' + word)
    return modified_lst 
'''
...
countries = ['Canada', 'Mexico', 'Brazil', 'Chile', 'Denmark', 'Botswana', 'Spain', 'Britain', 'Portugal', 'Russia', 'Thailand', 'Bangladesh', 'Nigeria', 'Argentina', 'Belarus', 'Laos', 'Australia', 'Panama', 'Egybpt', 'Morocco', 'Switzerland', 'Belgium']
